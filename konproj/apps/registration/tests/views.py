...
class RegistrationViewTests(TestCase):
    ...
    def test_registration_view_initial(self):
        ...
        self.assertTemplateUsed(response,
                                'bstrap3.2.0/registration/registration_form.html')
    ...
    def test_registration_template_name(self):
        ...
        self.assertTemplateUsed(response,
                                'bstrap3.2.0/registration/test_template_name.html')
    ...
    def test_activation_template_name(self):
        ...
        self.assertTemplateUsed(response, 'bstrap3.2.0/registration/test_template_name.html')

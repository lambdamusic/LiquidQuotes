...
def activate(request, backend,
			 template_name='bstrap3.2.0/registration/activate.html',
	...
	``bstrap3.2.0/registration/activate.html`` to display an error message; to
	...
	**Arguments**
	...
	``template_name``
		...
		this will default to ``bstrap3.2.0/registration/activate.html``.
	...
	**Template:**
	...
	bstrap3.2.0/registration/activate.html or ``template_name`` keyword argument.
...
def register(request, backend, success_url=None, form_class=None,
			 ...
			 template_name='bstrap3.2.0/registration/registration_form.html',
			 extra_context=None):
	"""
	...
	**Optional arguments**
	...
	``template_name``
		...
		to ``bstrap3.2.0/registration/registration_form.html``.
	...
	**Template:**
	...
	bstrap3.2.0/registration/registration_form.html or ``template_name`` keyword
	argument.

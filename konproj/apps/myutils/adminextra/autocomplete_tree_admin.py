...
class FkSearchInput(ForeignKeyRawIdWidget):
	...
	class Media:
		css = {
			'all': ('libs/autocomplete/css/jquery.autocomplete.css',)
		}
		js = (
			'libs/autocomplete/js/jquery.js',
			'libs/autocomplete/js/jquery.bgiframe.min.js',
			'libs/autocomplete/js/jquery.ajaxQueue.js',
			'libs/autocomplete/js/jquery.autocomplete.js',
		)
...
try:
	from myutils.mpttextra import feincms_tree_editor

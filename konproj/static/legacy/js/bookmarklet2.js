    ...
    if(!window.jQuery) {
      ...
      (function($) {
        ...
        var
          ...
          $iframe = $('<iframe></iframe>').css({'width': '100%', 'height': '100%', 'border': 1, 'overflow': 'hidden'}).prop({'src': 'http://127.0.0.1:8000/actions/new/koncept/', 'width': '100%', 'height': '100%', 'scrolling': 'no'}),
